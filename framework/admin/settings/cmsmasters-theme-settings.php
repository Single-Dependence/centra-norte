...
function cmsmasters_get_settings() {
	...
	case CMSMASTERS_PAGE_BASENAME:
		...
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', cmsmasters_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', cmsmasters_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', cmsmasters_options_general_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-font':
		...
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', cmsmasters_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', cmsmasters_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', cmsmasters_options_font_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-color':
		...
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', cmsmasters_options_color_fields(), $tab);
	...
	case CMSMASTERS_PAGE_BASENAME . '-element':
		...
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', cmsmasters_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', cmsmasters_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', cmsmasters_options_element_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-single':
		...
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', cmsmasters_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', cmsmasters_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', cmsmasters_options_single_tabs());
...
function cmsmasters_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 				esc_html__('Do you really want to remove this sidebar?', 'mall'), 
		'find' => 							esc_attr__('Find icons', 'mall'), 
		'remove_icon' => 					esc_html__('Do you really want to remove this social icon?', 'mall'), 
