...
function cmsmasters_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					esc_attr__('Clear', 'mall'),
		'clearAriaLabel' => 		esc_attr__('Clear color', 'mall'),
		'defaultLabel' => 			esc_attr__('Color value', 'mall'),
		'defaultString' => 			esc_attr__('Default', 'mall'),
		'defaultAriaLabel' => 		esc_attr__('Select default color', 'mall'),
		'pick' => 					esc_attr__('Select Color', 'mall'),
	) ); 
	...
	wp_localize_script('cmsmasters-lightbox-js', 'cmsmasters_admin_lightbox', array( 
		...
		'min_length' => 			esc_attr__('min 2 symbols', 'mall'), 
		'choose_font' => 			esc_attr__('Choose icons font', 'mall'), 
