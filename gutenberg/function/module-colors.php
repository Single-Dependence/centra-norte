...
function cmsmasters_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} div.wp-block ul > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_bg']) . "
	}

	{$editor} .wp-block-quote,
	.editor-styles-wrapper .wp-block-freeform blockquote,
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_color']) . "
	}
	
	{$editor} .wp-block-cover,
	{$editor} .wp-block-cover a,
	{$editor} .wp-block-cover a:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_alternate']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform table tbody tr td {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['mall' . '_default_border']) . "
	}

	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_alternate']) . "
	}
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-search__button:before, 
	...
	.editor-styles-wrapper .wp-block-file .wp-block-file__textlink {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_link']) . "
	}

	{$editor} .wp-block-search .wp-block-search__input:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['mall' . '_default_link']) . "
	}
	...
	.editor-styles-wrapper div.wp-block .wp-block-freeform.block-library-rich-text__tinymce a:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_hover']) . "
	}
	
	.editor-styles-wrapper .wp-block select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['mall' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['mall' . '_default_heading']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_bg']) . "
	}
	...
	{$editor} .wp-block-separator.is-style-dots:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_border']) . "
	}
	
	{$editor} .wp-block-separator:not(.is-style-dots):before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['mall' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['mall' . '_default_hover']) . "
	}
...
";
	$custom_css .= cmsmasters_gutenberg_editor_color_palettes_styles( true );
	
	return $custom_css;
}

add_filter('cmsmasters_theme_colors_secondary_filter', 'cmsmasters_gutenberg_module_colors');
